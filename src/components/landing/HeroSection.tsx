      ...
      <div className="container px-4 mx-auto max-w-7xl">
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 text-left">
            {[
              { text: "Analyze market rents with advanced algorithms", id: 1 },
              { text: "Generate detailed property comparison reports", id: 2 },
              { text: "Support housing assistance program compliance", id: 3 }
            ].map((item) => (
